...
All phases built, plus the 2026-09-24 review fixes and the web card port. Status: **waiting on Oskar** — migrations are live; upload the art (the 45 Noto emoji are ready) and run the device checks (both under Needs Oskar).
...
- 2026-09-24 — Migrations live: Oskar applied 0000–0004; 0005 (the review fixes, re-created functions only) applied via the connector and verified; security advisor shows nothing new beyond the intended signed-in RPCs.
