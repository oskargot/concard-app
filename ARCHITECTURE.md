...
Deployment: Distributed via Expo Go during development (every dependency, Skia included, ships
inside Expo Go — see "Why Skia" in `CLAUDE.md`). No CI/CD or store deployment pipeline is configured
